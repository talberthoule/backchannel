...
export function mount({ document, fetcher, shell, dialogs }) {
  ...
  function render() {
    ...
    function showDetail(record, trigger) {
      ...
      detailPane.replaceChildren(back, heading, identityTitle, identity, securityTitle, security);
