...
INSIGHTS = [
    ("action_item", "action_tracker", "Send the fixed recovery pilot scope by Thursday noon", "Owen can sponsor the pilot once the stated guardrails and commercial boundary are in writing.", "I will send the fixed pilot scope, separate managed-operations option, and operating boundary by Thursday noon", "Me", True, False, "", False, "", "Recovery Implementation Pilot", True),
    ("action_item", "action_tracker", "Open the identity change request on day one", "The ten-working-day approval clock must run in parallel with discovery to protect the September evidence date.", "the change request opens on day one, in parallel with discovery", "Me", True, False, "", False, "", "", True),
    ...
    ("action_item", "action_tracker", "Include a board-ready evidence outline in the proposal", "Maya wants the insurer to clear the evidence shape before the recovery test.", "Add the board-ready evidence outline", "Maya", True, False, "", False, "", "Recovery Readiness Assessment", True),
    ...
    ("opportunity", "opportunity_scout", "Recovery Readiness Assessment", "Alderwake needs an evidence-backed gap analysis before committing to broader remediation.", "I need something defensible, not a polished diagram", "Maya", True, False, "", False, "", "Recovery Readiness Assessment", True),
    ("opportunity", "opportunity_specialist", "Recovery Implementation Pilot", "The customer has budget, a deadline, a narrow technical scope, and accepted non-disruptive validation guardrails.", "If the scope holds those guardrails, I can sponsor it", "Owen", True, False, "", False, "", "Recovery Implementation Pilot", True),
    ...
    ("observation", "observer", "The real failure was remote operating readiness, not backup integrity", "The vault restored data, but sequencing and authority assumptions broke when responders were not onsite.", "The recovery vault worked, but nobody had confirmed who could authorize", "Maya", True, False, "", False, "", "", True),
    ("observation", "observer", "The board deadline is earlier than the insurer deadline", "September 18 is the effective compelling event because the risk committee must review evidence first.", "The board risk committee meets September 18", "Maya", True, False, "", False, "", "", True),
