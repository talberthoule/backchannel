...
## One survivor, cleared 2026-08-02

The social share card (`site/assets/og-image.png`) was composed by hand in July
2026 around one of these screenshots and outlived the retirement by five weeks
-- on the most-seen image the project has, since every link preview renders it.
It is now generated from the fictional capture by `showcase/og_card.mjs`. If you
find another asset that cannot be regenerated by a script in `showcase/`, treat
it as suspect for the same reason.
