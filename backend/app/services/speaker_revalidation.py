...
async def _enhance_insights_with_fallback(
    ...
    The primary is the synthesizer agent row's model (ALP-157), resolved here
    rather than left to run_speaker_context_batch's default because every
    attempt passes an explicit model_id. Reading the global setting here would
