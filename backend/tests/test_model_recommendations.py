...
class CloudRecommendationTests(unittest.IsolatedAsyncioTestCase):
    async def test_registry_exposes_the_approved_role_matrix(self):
        ...
        expected = {
            ...
            ("consolidated_analyst", "google"): "gemini-3.8-flash",
            ...
            ("opportunity_specialist", "google"): "gemini-3.8-flash",
            ("opportunity_specialist", "openai"): "gpt-5.6-luna",
            ("strategic_signals", "google"): "gemini-3.8-flash",
            ("strategic_signals", "openai"): "gpt-5.6-terra",
            ("brief_meeting_lens", "google"): "gemini-3.8-flash",
            ("brief_meeting_lens", "openai"): "gpt-5.6-terra",
            ("brief_discovery_lens", "google"): "gemini-3.8-flash",
            ("brief_discovery_lens", "openai"): "gpt-5.6-terra",
            ("brief_arbiter", "google"): "gemini-3.8-flash",
            ("brief_arbiter", "openai"): "gpt-5.6-sol",
            ("live_ask", "google"): "gemini-3.8-flash",
        ...
        self.assertIn(
            "strategic_signals",
            {item["role"] for item in by_id["gemini-3.8-flash"]["recommendations"]},
        )
        self.assertEqual(
            {"brief_arbiter"},
